...
// ---------------------------------------------------------------------------
// Markdown-lite renderer (bold + bullet support)
// ---------------------------------------------------------------------------
      ...
      <div style={{
        ...
        {[0, 1, 2].map((i) => (
          <span key={i} style={{
            ...
            animation: `ariaPulse 1.2s ease-in-out ${i * 0.2}s infinite`,
          }} />
        ))}
      </div>
    </div>
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "calc(100dvh - 100px)", maxWidth: "780px", margin: "0 auto" }}>
      ...
      <div style={{
        ...
        <span style={{
          ...
          color: "var(--blue)",
          letterSpacing: "0.06em",
        }}>Diamond Mind Intelligence</span>
        <span style={{
          fontFamily: "var(--font-mono)",
          fontSize: "10px",
          color: "var(--text-3)",
      ...
      <div style={{
        ...
        <textarea
          ...
          onKeyDown={onKey}
          placeholder="Ask ARIA anything about today's slate, picks, or model…"
          rows={2}
          style={{
            flex: 1,
            background: "var(--surface)",
